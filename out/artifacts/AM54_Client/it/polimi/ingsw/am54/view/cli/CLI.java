...
public class CLI implements View {
    ...
    /**
     * Method that displays files (ASCII art).
     * @param fileName name of file to be displayed
     */
    public void printFile(String fileName){
        //ClassLoader classLoader = getClass().getClassLoader();
        File file = new File(String.valueOf(CLI.class.getResource(fileName)));
    ...
    public void showIslands() {
        ...
        for (Island is: islands) {
            String mn;
            if(islands.get(motherNature).getID() == is.getID())
                mn = "yes";
            else
                mn = "no";
    ...
    private void showGameBoard(GameBoard gb) {
        ...
        System.out.format("+----------+-----------------------------------------+-----------+%n");
        System.out.format("+ Towers: "+towers.get(0).getColor()+" "+towers.size()+"                                       Coins: "+gb.getCoins()+" +%n");
        System.out.format("+----------+-----------------------------------------+-----------+%n");
