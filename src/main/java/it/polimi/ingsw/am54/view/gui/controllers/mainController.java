...
public class mainController implements GUIInputHandler {
    ...
    /**
     * enables interactions for the planning phase.
     */
    ...
    /**
     * enables interactions for the action phase.
     */
    ...
    /**
     * enables interactions for selecting clouds.
     */
    ...
    public void update(updateMessage update){
        ...
        rightAnchorController.update(update.players, update.description, update.currentPlayer);
    ...
    /**
     * activates animation for BottomPanel
     */
    ...
    /**
     * activates animation for RightPanel
     */
    ...
    /**
     * activates animation for TopPanel
     */
