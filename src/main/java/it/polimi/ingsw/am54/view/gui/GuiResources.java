...
public final class GuiResources {
    ...
    public static String mage(Mage mage){
        return "/GUI_images/graphical_assets/Assistenti/retro/"+mage.name() +"@3x.png";
    }
    public static String winScreen = "/fxmls/youWin.fxml";
    public static String loseScreen = "/fxmls/youLose.fxml";
